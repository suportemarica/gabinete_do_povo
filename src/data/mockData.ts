    ...
    conditions: [
      {
        id: 'cond-1',
        questionId: 'q1',
        questionText: 'Qual o tipo da sua solicitação?',
        operator: 'equals',
        value: 'Reclamação',
        questionType: 'select',
        questionOptions: ['Reclamação', 'Sugestão', 'Elogio', 'Denúncia', 'Solicitação de Serviço'],
      },
      {
        id: 'cond-2',
        questionId: 'q2',
        questionText: 'Em qual área você deseja fazer sua solicitação?',
        operator: 'equals',
        value: 'Obras Públicas',
        questionType: 'select',
        questionOptions: ['Obras Públicas', 'Saúde', 'Educação', 'Meio Ambiente', 'Transporte', 'Segurança'],
      },
    ],
    logicalOperator: 'AND',
    action: {
